...
DEFAULT_EMBEDDING_MODEL = "openai_small"
DEFAULT_VECTOR_DB_PATH = DATA_DIR / f"{DEFAULT_EMBEDDING_MODEL}_cs{DEFAULT_CHUNK_SIZE}_co{DEFAULT_CHUNK_OVERLAP}_ed{DEFAULT_EMBEDDING_DIM}_bs{DEFAULT_BATCH_SIZE}.sqlite"
